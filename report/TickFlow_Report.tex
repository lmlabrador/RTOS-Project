...
\begin{itemize}
  \item \textbf{LO-task suspension events}: T2 (LO) is suspended immediately on every mode switch. Its in-progress job is removed from the ready queue and logged as a \texttt{suspension} event.
